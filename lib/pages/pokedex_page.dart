...
class _PokedexPageState extends State<PokedexPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          backgroundColor: const Color.fromARGB(248, 112, 51, 182),
          title: Container(
                  ...
                  return Stack(
                    children: [
                      Container(
                        ...
                        margin:
                            const EdgeInsets.only(right: 30, top: 50, left: 30),
                        height: 320,
                                                                  ...
                                                                  : tipo ==
                                                                      ...
                                                                      : tipo ==
                                                                          ...
                                                                          ? Colors
                                                                              .black26
                                                                          : tipo == 'Posion'
                                                                              ? const Color.fromARGB(255, 209, 17, 243)
                                                                              : const Color.fromARGB(255, 137, 19, 158),
